...
extern DWORD WINAPI RainbowThread(LPVOID lpParam);
extern DWORD WINAPI onceinabluemoon(LPVOID lpParam);
extern DWORD WINAPI ExecuteAll(LPVOID lpParam);
extern DWORD WINAPI invalidateScreen(LPVOID lpRedraw);